<?php
	class FeatureGroup extends PBObject {
		...
		// @return a list of all tags sorted by tag name
		public static function getAllTags() { return Helpers::execute('SELECT fea_id id, fea_name name FROM featuregroup ORDER BY fea_name ASC');}		
	}
?>